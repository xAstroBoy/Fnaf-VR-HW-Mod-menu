...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_9TMX[0xC];                                   // 0x0244(0x000C) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_F5HZ[0x56];                                  // 0x0242(0x0056) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7OWS[0x6];                                   // 0x003A(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_6N44[0x6];                                   // 0x02A2(0x0006) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_ZDM4[0x4];                                   // 0x016C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_SNPM[0x18];                                  // 0x0178(0x0018) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_7KG1[0x3];                                   // 0x0255(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_AOKE[0x20];                                  // 0x0268(0x0020) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_EVCI[0x8];                                   // 0x0240(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		class FString                                              buttonID;                                                // 0x0248(0x0010) Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected
		unsigned char                                              UnknownData_1S7N[0x8];                                   // 0x0258(0x0008) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KALA[0x10];                                  // 0x0248(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_N77V[0x48];                                  // 0x0248(0x0048) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YO4P[0x10];                                  // 0x0248(0x0010) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_0WSI[0x8];                                   // 0x00E8(0x0008) MISSED OFFSET (PADDING)
	...
	{
	public:
		unsigned char                                              UnknownData_YHYS[0x8];                                   // 0x0028(0x0008) MISSED OFFSET (PADDING)
