...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Prize_MangleMask.Prize_MangleMask_C
	 * Size -> 0x0AA0 (FullSize[0x0DA8] - InheritedSize[0x0308])
	 */
	class APrize_MangleMask_C : public APrize_Parent_C
	{
	public:
		...
		unsigned char                                              UnknownData_G090[0x7];                                   // 0x0321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_RT8P[0x7];                                   // 0x0861(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Prize_MangleMask(int EntryPoint);
