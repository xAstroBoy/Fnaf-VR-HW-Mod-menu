...
struct FMovieSceneSequencePlaybackSettings
{
	...
	TScriptInterface<class UMovieSceneBindingOverridesInterface> BindingOverrides;                                         // 0x0020(0x0030) (ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneSpawnable
{
	...
	struct FString                                     Name;                                                     // 0x0050(0x0010) (ZeroConstructor)
