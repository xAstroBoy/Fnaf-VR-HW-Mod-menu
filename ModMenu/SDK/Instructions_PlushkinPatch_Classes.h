...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * WidgetBlueprintGeneratedClass Instructions_PlushkinPatch.Instructions_PlushkinPatch_C
	 * Size -> 0x002C (FullSize[0x025C] - InheritedSize[0x0230])
	 */
	class UInstructions_PlushkinPatch_C : public UUserWidget
	{
	public:
		class UButton*                                             Button_105;                                              // 0x0230(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
		...
		class UInstructions_Base_C*                                Instructions_Base;                                       // 0x0240(0x0008) BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash
