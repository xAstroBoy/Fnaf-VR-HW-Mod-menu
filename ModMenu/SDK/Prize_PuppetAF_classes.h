...
namespace CG
{
	...
	public:
		...
		class UStaticMeshComponent*                                Mariomette;                                              // 0x0310(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
