...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_TY2F[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_KLFG[0xF];                                   // 0x0001(0x000F) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_OMN7[0xB];                                   // 0x0015(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
	public:
		unsigned char                                              UnknownData_UFAP[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		struct FFilterOptionPerAxis                                AxesFilterOption;                                        // 0x0008(0x0003) Edit, NoDestructor, NativeAccessSpecifierPublic
		unsigned char                                              UnknownData_JPND[0x5];                                   // 0x000B(0x0005) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_H77E[0x3];                                   // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		unsigned char                                              UnknownData_WFII[0x7];                                   // 0x0011(0x0007) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_YEN0[0x3];                                   // 0x000D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_5PTQ[0x3];                                   // 0x0025(0x0003) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_XIY4[0x4];                                   // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_ETF7[0x4];                                   // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		TMap<class FName, int>                                     NodeNameToIndexMapping;                                  // 0x0020(0x0050) ZeroConstructor, NativeAccessSpecifierPublic
	...
	{
	public:
		unsigned char                                              UnknownData_PMYN[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
