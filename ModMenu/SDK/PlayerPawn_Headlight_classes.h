...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_66OP[0x4];                                   // 0x0FBC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_JR2C[0x6];                                   // 0x0FCA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
