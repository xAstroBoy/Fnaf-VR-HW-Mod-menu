...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_VYU8[0x4];                                   // 0x0FBC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_I9TF[0x6];                                   // 0x0FCA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
