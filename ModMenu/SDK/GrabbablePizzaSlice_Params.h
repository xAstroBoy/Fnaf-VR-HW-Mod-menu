...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * Function GrabbablePizzaSlice.GrabbablePizzaSlice_C.GetEdibleType
	 */
	struct AGrabbablePizzaSlice_C_GetEdibleType_Params
	{
	public:
	...
	/**
	 * Function GrabbablePizzaSlice.GrabbablePizzaSlice_C.OnActorEaten
	 */
	struct AGrabbablePizzaSlice_C_OnActorEaten_Params
	{
	public:
