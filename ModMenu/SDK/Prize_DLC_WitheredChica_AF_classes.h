...
namespace CG
{
	...
	public:
		...
		class UStaticMeshComponent*                                Chica;                                                   // 0x0310(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
