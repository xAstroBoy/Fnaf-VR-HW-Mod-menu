...
// BlueprintGeneratedClass Maze_Key.Maze_Key_C
// 0x0028 (0x0350 - 0x0328)
class AMaze_Key_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                        Bowser_Key;                                               // 0x0338(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USceneComponent*                             Scene;                                                    // 0x0340(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	TEnumAsByte<EKey_Color>                            Key_Type;                                                 // 0x0348(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0349(0x0003) MISSED OFFSET
	int                                                Key_Location_ID;                                          // 0x034C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Maze_Key.Maze_Key_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Maze_Key(int EntryPoint);
};
