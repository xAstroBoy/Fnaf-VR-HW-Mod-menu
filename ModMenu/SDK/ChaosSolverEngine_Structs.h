...
namespace CG
{
	...
	{
	public:
		unsigned char                                              UnknownData_IOCR[0x8];                                   // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		unsigned char                                              ChaosHandlers[0x50];                                     // 0x0000(0x0050) UNKNOWN PROPERTY: SetProperty ChaosSolverEngine.ChaosHandlerSet.ChaosHandlers
	...
	{
	public:
		unsigned char                                              UnknownData_RKI1[0x40];                                  // 0x0000(0x0040) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_JZG4[0x4];                                   // 0x006C(0x0004) MISSED OFFSET (PADDING)
