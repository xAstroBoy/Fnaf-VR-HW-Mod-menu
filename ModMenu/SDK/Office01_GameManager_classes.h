...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_XJ1T[0x1];                                   // 0x03AF(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_Y5HP[0x3];                                   // 0x040D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
