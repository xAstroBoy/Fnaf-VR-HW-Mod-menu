...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_COZB[0x1C];                                  // 0x0064(0x001C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_U3KA[0x3];                                   // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_IOL6[0x4];                                   // 0x008C(0x0004) MISSED OFFSET (PADDING)
	...
	public:
		...
		unsigned char                                              UnknownData_2YDS[0x7];                                   // 0x0059(0x0007) MISSED OFFSET (PADDING)
