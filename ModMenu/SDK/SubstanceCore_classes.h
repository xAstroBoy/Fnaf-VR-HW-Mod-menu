...
public:
	...
	struct FString                                     SourceFilePath;                                           // 0x0128(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst)
	struct FString                                     SourceFileTimestamp;                                      // 0x0138(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst)
...
public:
	...
	bool                                               bCooked;                                                  // 0x0102(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1D];                                      // 0x0103(0x001D) MISSED OFFSET
