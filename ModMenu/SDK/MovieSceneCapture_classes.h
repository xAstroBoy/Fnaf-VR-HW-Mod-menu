...
public:
	...
	struct FString                                     AdditionalCommandLineArguments;                           // 0x00D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Config)
	struct FString                                     InheritedCommandLineArguments;                            // 0x00E0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, Transient)
...
public:
	...
	struct FString                                     VideoCodec;                                               // 0x0070(0x0010) (Edit, ZeroConstructor, Config)
