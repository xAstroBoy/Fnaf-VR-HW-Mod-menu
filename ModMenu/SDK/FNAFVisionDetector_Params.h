...
namespace CG
{
	...
	public:
		...
		bool                                                       IsInLOS;                                                 // 0x0000(0x0001)  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	{
	public:
		class UPrimitiveComponent*                                 visioncone;                                              // 0x0000(0x0008)  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
