...
namespace CG
{
	...
	{
	public:
		class UStaticMeshComponent*                                ENV_MOD_Desk_Fan_Fanblade;                               // 0x0308(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
