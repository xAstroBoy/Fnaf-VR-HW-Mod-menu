...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Prize_BonnieMask.Prize_BonnieMask_C
	 * Size -> 0x0AA0 (FullSize[0x0DA8] - InheritedSize[0x0308])
	 */
	class APrize_BonnieMask_C : public APrize_Parent_C
	{
	public:
		...
		unsigned char                                              UnknownData_1JJO[0x7];                                   // 0x0321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_37XF[0x7];                                   // 0x0861(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Prize_BonnieMask(int EntryPoint);
