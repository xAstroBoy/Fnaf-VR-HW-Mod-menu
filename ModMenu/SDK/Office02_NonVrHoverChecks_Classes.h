...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Office02_NonVrHoverChecks.Office02_NonVrHoverChecks_C
	 * Size -> 0x0019 (FullSize[0x0259] - InheritedSize[0x0240])
	 */
	class AOffice02_NonVrHoverChecks_C : public AActor
	{
	public:
	...
	public:
		...
		void ExecuteUbergraph_Office02_NonVrHoverChecks(int EntryPoint);
