...
namespace CG
{
	...
	public:
		...
		class UStaticMeshComponent*                                Sphere1;                                                 // 0x0250(0x0008) BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash
		...
		bool                                                       IsInactiveLoc;                                           // 0x0270(0x0001) Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor
