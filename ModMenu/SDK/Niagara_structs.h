...
struct FNiagaraParameterStore
{
	...
	TMap<struct FNiagaraVariable, int>                 ParameterOffsets;                                         // 0x0008(0x0050) (ZeroConstructor)
	TArray<unsigned char>                              ParameterData;                                            // 0x0058(0x0010) (ZeroConstructor)
	TArray<class UNiagaraDataInterface*>               DataInterfaces;                                           // 0x0068(0x0010) (ZeroConstructor)
...
{
	int                                                ParameterSize;                                            // 0x00E0(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           PaddedParameterSize;                                      // 0x00E4(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNiagaraScriptExecutionPaddingInfo>  PaddingInfo;                                              // 0x00E8(0x0010) (ZeroConstructor)
	unsigned char                                      bInitialized : 1;                                         // 0x00F8(0x0001)
...
struct FNiagaraVariableMetaData
{
	...
	int                                                CallSortPriority;                                         // 0x0084(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<TWeakObjectPtr<class UObject>>              ReferencerNodes;                                          // 0x0088(0x0010) (ZeroConstructor)
};
