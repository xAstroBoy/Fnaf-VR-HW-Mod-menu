...
// BlueprintGeneratedClass Prize_ToyBonnie.Prize_ToyBonnie_C
// 0x0010 (0x03E8 - 0x03D8)
class APrize_ToyBonnie_C : public APrize_Parent_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Prize_ToyBonnie.Prize_ToyBonnie_C");
		return ptr;
	}
