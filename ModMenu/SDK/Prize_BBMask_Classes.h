...
namespace CG
{
	...
	// --------------------------------------------------
	/**
	 * BlueprintGeneratedClass Prize_BBMask.Prize_BBMask_C
	 * Size -> 0x0AA0 (FullSize[0x0DA8] - InheritedSize[0x0308])
	 */
	class APrize_BBMask_C : public APrize_Parent_C
	{
	public:
		...
		unsigned char                                              UnknownData_W181[0x7];                                   // 0x0321(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_3M45[0x7];                                   // 0x0861(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	public:
		...
		void ExecuteUbergraph_Prize_BBMask(int EntryPoint);
