...
namespace CG
{
	...
	public:
		...
		unsigned char                                              UnknownData_V6TU[0x6];                                   // 0x0432(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_H4B6[0x2];                                   // 0x0486(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
		...
		unsigned char                                              UnknownData_TM7N[0x18];                                  // 0x04A8(0x0018) MISSED OFFSET (PADDING)
