...
bool allocate_console() {
	if (AllocConsole() != NULL) {
		SetConsoleTitleW(TEXT("Five Night at Freddy's HELP Wanted MOD Console Built by marcocorriero#0001 For STEAM ONLY!"));
...
void ConsoleInput()
{
	...
	if (input == "help")
	{
		...
		cout << "For fullbright MOD ASK FOR SHADER HACK TO marcocorriero#1337";
