...
// BlueprintGeneratedClass GrabbableRoach_NoEatKill.GrabbableRoach_NoEatKill_C
// 0x0028 (0x0350 - 0x0328)
class AGrabbableRoach_NoEatKill_C : public AActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0328(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class USkeletalMeshComponent*                      RIG_Roach;                                                // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class ASaul_MotionControllerPawn_C*                RefToMotionController;                                    // 0x0348(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass GrabbableRoach_NoEatKill.GrabbableRoach_NoEatKill_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GrabbableRoach_NoEatKill(int EntryPoint);
};
