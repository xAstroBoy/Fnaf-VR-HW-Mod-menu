...
// BlueprintGeneratedClass MPUIDisplayActor.MPUIDisplayActor_C
// 0x0038 (0x0360 - 0x0328)
class AMPUIDisplayActor_C : public AActor
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0328(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	class USceneComponent*                             Vision;                                                   // 0x0330(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	class UWidgetComponent*                            MPUI;                                                     // 0x0348(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass MPUIDisplayActor.MPUIDisplayActor_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_MPUIDisplayActor(int EntryPoint);
};
