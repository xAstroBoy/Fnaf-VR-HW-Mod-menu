...
public:
	...
	unsigned char                                      bReverseAsBrake : 1;                                      // 0x0180(0x0001) (Edit)
	unsigned char                                      bUseRVOAvoidance : 1;                                     // 0x0180(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bRawHandbrakeInput : 1;                                   // 0x0180(0x0001) (Transient)
	unsigned char                                      bRawGearUpInput : 1;                                      // 0x0180(0x0001) (Transient)
	unsigned char                                      bRawGearDownInput : 1;                                    // 0x0180(0x0001) (Transient)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0181(0x0003) MISSED OFFSET
	unsigned char                                      bWasAvoidanceUpdated : 1;                                 // 0x0184(0x0001) (Transient)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0185(0x0003) MISSED OFFSET
	float                                              Mass;                                                     // 0x0188(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	float                                              DragCoefficient;                                          // 0x01A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisWidth;                                             // 0x01A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ChassisHeight;                                            // 0x01A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	struct FVector                                     InertiaTensorScale;                                       // 0x01BC(0x000C) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData05[0x18];                                      // 0x01F8(0x0018) MISSED OFFSET
	float                                              RVOAvoidanceRadius;                                       // 0x0210(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOAvoidanceHeight;                                       // 0x0214(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceConsiderationRadius;                             // 0x0218(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOSteeringStep;                                          // 0x021C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RVOThrottleStep;                                          // 0x0220(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AvoidanceUID;                                             // 0x0224(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, IsPlainOldData)
	struct FNavAvoidanceMask                           AvoidanceGroup;                                           // 0x0228(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToAvoid;                                            // 0x022C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FNavAvoidanceMask                           GroupsToIgnore;                                           // 0x0230(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceWeight;                                          // 0x0234(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector                                     PendingLaunchVelocity;                                    // 0x0238(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FReplicatedVehicleState                     ReplicatedState;                                          // 0x0244(0x0014) (Net, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0258(0x0004) MISSED OFFSET
	float                                              RawSteeringInput;                                         // 0x025C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawThrottleInput;                                         // 0x0260(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              RawBrakeInput;                                            // 0x0264(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              SteeringInput;                                            // 0x0268(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              ThrottleInput;                                            // 0x026C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              BrakeInput;                                               // 0x0270(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              HandbrakeInput;                                           // 0x0274(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	float                                              IdleBrakeInput;                                           // 0x0278(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              StopThreshold;                                            // 0x027C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              WrongDirectionThreshold;                                  // 0x0280(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVehicleInputRate                           ThrottleInputRate;                                        // 0x0284(0x0008) (Edit)
	struct FVehicleInputRate                           BrakeInputRate;                                           // 0x028C(0x0008) (Edit)
	struct FVehicleInputRate                           HandbrakeInputRate;                                       // 0x0294(0x0008) (Edit)
	struct FVehicleInputRate                           SteeringInputRate;                                        // 0x029C(0x0008) (Edit)
	unsigned char                                      UnknownData07[0x24];                                      // 0x02A4(0x0024) MISSED OFFSET
	class AController*                                 OverrideController;                                       // 0x02C8(0x0008) (Net, ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      UnknownData00[0x590];                                     // 0x0360(0x0590) MISSED OFFSET
...
{
public:
	struct FVehicleEngineData                          EngineSetup;                                              // 0x02D0(0x0090) (Edit)
	struct FVehicleDifferential4WData                  DifferentialSetup;                                        // 0x0360(0x001C) (Edit)
	float                                              AckermannAccuracy;                                        // 0x037C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVehicleTransmissionData                    TransmissionSetup;                                        // 0x0380(0x0030) (Edit)
