...
public:
	...
	struct FString                                     DefaultFilmbackPresetName;                                // 0x0828(0x0010) (ZeroConstructor, Config)
	struct FString                                     DefaultLensPresetName;                                    // 0x0838(0x0010) (ZeroConstructor, Config)
